...
@Entity
@Table(name = "oczekujace_szczepienia", schema = "punkt_szczepien")
public class OczekujaceSzczepienia {
    @Id
    private Long id;
    ...
    public OczekujaceSzczepienia(String pesel, String imie, String nazwisko, String nazwaSzczepienia, String producent, Date data, Time godzina) {
        this.pesel = pesel;
        this.imie = imie;
    ...
    public boolean equals(Object o) {
        ...
        OczekujaceSzczepienia that = (OczekujaceSzczepienia) o;
    ...
    public static ArrayList<OczekujaceSzczepienia> getOczek(ArrayList<String> peselList, ArrayList<String> ImieList, ArrayList<String>
        ...
        ArrayList<OczekujaceSzczepienia> oczek = new ArrayList<>();
        for (int i = 0; i < peselList.size(); i++)
            oczek.add(new OczekujaceSzczepienia(peselList.get(i), ImieList.get(i), NazwiskoList.get(i),
